...
function ViscoLogo({ size = 48, light = false }: { size?: number; light?: boolean }) {
  const color = light ? "#fff" : PRIMARY;
  const barColor = light ? "rgba(255,255,255,0.5)" : "#4a4a4a";
  return (
    <svg width={size * 2.8} height={size} viewBox="0 0 160 58" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* VISCO */}
      <text x="0" y="26" fontFamily="Georgia, 'Times New Roman', serif" fontWeight="700" fontSize="26" fill={color} letterSpacing="1">V</text>
      {/* vertical bar after V */}
      <rect x="22" y="2" width="2.5" height="24" fill={barColor}/>
      <text x="28" y="26" fontFamily="Georgia, 'Times New Roman', serif" fontWeight="700" fontSize="26" fill={color} letterSpacing="1">SCO</text>
      {/* ORINOCO */}
      <text x="0" y="54" fontFamily="Georgia, 'Times New Roman', serif" fontWeight="700" fontSize="26" fill={color} letterSpacing="1">OR</text>
      {/* vertical bar in ORINOCO */}
      <rect x="42" y="30" width="2.5" height="24" fill={barColor}/>
      <text x="48" y="54" fontFamily="Georgia, 'Times New Roman', serif" fontWeight="700" fontSize="26" fill={color} letterSpacing="1">NOCO</text>
    </svg>
  );
}
...
export default function Login() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Crimson Text', Georgia, serif", background: "#F5F5F7" }}>
      <style>{`
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <h2 style={{
            ...
            <span style={{ color: "rgba(255,255,255,0.55)" }}>inteligente y eficiente.</span>
          </h2>
          <p style={{
            fontFamily: "'DM Sans', sans-serif",
            fontSize: 14,
            ...
            Controla inventario, proveedores y órdenes de compra desde una sola plataforma empresarial.
          </p>
        </div>
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            <div key={s.label} className="stat-chip">
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: "rgba(255,255,255,0.5)", letterSpacing: "0.06em", textTransform: "uppercase" }}>{s.label}</div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 600, color: "#fff", marginTop: 1 }}>{s.value}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{
        ...
        <div className="panel-fade-in" style={{ width: "100%", maxWidth: 400 }}>
          ...
          <div style={{
            ...
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#9CA3AF" }}>o continúa con</span>
            <div style={{ flex: 1, height: 1, background: "#E5E7EB" }}/>
          </div>
          ...
          <p style={{
            ...
            ¿No tienes cuenta?{" "}
            <a href="/register" className="link-red">Solicitar acceso</a>
          </p>
        </div>
      </div>
    </div>
